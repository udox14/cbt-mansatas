...
import { LogOut, ArrowLeft, Layers, Shield } from 'lucide-react';
...
import { KegiatanDashboard } from '@/features/kegiatan/KegiatanDashboard';
import { KegiatanEventWorkspace } from '@/features/kegiatan/KegiatanEventWorkspace';
...
function KegiatanContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', flexDirection: 'column', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <button
            onClick={() => { window.location.href = '/app/select-mode'; }}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '6px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', borderLeft: `1.5px solid ${C.borderLight}`, paddingLeft: '14px' }}>
      ...
      {/* Main Container */}
      <main style={{ flex: 1, maxWidth: '1200px', width: '100%', margin: '0 auto', padding: '24px 20px', position: 'relative', zIndex: 1 }}>
        {selectedEventId ? (
          <KegiatanEventWorkspace
      ...
      {/* Footer */}
      <footer style={{ textAlign: 'center', padding: '16px', color: '#a8b3a8', fontSize: '11.5px', fontWeight: 500, borderTop: `1px solid ${C.borderLight}`, background: C.white }}>
