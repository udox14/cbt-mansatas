...
import { SemesterDashboard } from '@/features/semester/SemesterDashboard';
import { SemesterWorkspace } from '@/features/semester/SemesterWorkspace';
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
            ...
            <div>
              <p style={{ color: C.text, fontSize: '11px', fontWeight: 800, lineHeight: 1.2 }}>
                CBT MANSATAS · UJIAN SEMESTER & AKHIR TAHUN
              </p>
